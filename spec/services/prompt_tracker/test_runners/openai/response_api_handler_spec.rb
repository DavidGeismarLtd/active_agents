...
module PromptTracker
  module TestRunners
    module Openai
      RSpec.describe ResponseApiHandler, type: :service do
        let(:model_config) do
          {
            provider: "openai",
            api: "responses",
        ...
        describe "#execute" do
          ...
          context "when handler instance is reused for multiple execute calls" do
            it "correctly extracts tool results from each execution independently" do
              ...
              allow(handler).to receive(:mock_response_api_response).and_return(
                {
                  text: "First response",
                  response_id: "resp_1",
              ...
              first_result = handler.execute(params)
              ...
              second_result = handler.execute(params)
