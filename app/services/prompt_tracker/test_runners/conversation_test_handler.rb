...
module PromptTracker
  module TestRunners
    # Base class for conversation test handlers.
    #
    ...
    #
    # Each handler is responsible for a specific API type (Chat Completion,
