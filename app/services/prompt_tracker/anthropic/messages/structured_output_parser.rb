...
module PromptTracker
  module Anthropic
    module Messages
      # Parses structured output responses from Claude/Anthropic models.
      #
      # When using RubyLLM's `with_schema()` feature with Anthropic models,
      # the response is returned as a String (often wrapped in markdown code blocks)
      # rather than a parsed Hash like OpenAI provides.
      #
      # This parser handles:
      ...
      #
      # @example Parse a Claude response
