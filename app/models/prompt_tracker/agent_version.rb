...
# == Schema Information
#
# Table name: prompt_tracker_agent_versions
#
...
module PromptTracker
  ...
  #
  # AgentVersions are immutable once they have LLM responses. This ensures
  ...
  class AgentVersion < ApplicationRecord
    ...
    validates :version_number,
              uniqueness: { scope: :agent_id, message: "already exists for this prompt" }
    ...
    # @return [ActiveRecord::Relation<AgentVersion>]
    ...
    def activate!
      transaction do
        ...
        agent.agent_versions.where.not(id: id).update_all(status: "deprecated")
    ...
    # =====================
    # A AgentVersion can be in one of three states based on its associations:
    ...
    # AgentVersions include a "Template" column to show the user_prompt preview.
    #
    ...
    def set_next_version_number
      max_version = agent.agent_versions.maximum(:version_number) || 0
