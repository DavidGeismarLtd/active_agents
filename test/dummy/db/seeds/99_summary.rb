...
puts "  - #{PromptTracker::Openai::Assistant.count} OpenAI assistants"
...
puts "    - #{PromptTracker::Test.where(testable_type: 'PromptTracker::Openai::Assistant').count} for assistants"
...
puts "\n🎉 Ready to explore!"
puts "\n💡 Tips:"
puts "  - Visit /prompt_tracker to see all prompts and assistants"
puts "  - Check out the 3 OpenAI assistants:"
puts "    • Medical Triage Assistant (healthcare)"
puts "    • Customer Support Assistant (general support)"
puts "    • Technical Support Assistant (troubleshooting)"
...
puts "  - Run assistant tests to see ConversationJudgeEvaluator in action"
